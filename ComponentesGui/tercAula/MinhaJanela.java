...
public class MinhaJanela extends JFrame implements ActionListener
{
	...
	public MinhaJanela()
	{
		...
		//registro dos componentes visuais ao ouvinte
		//Obs: O paramentro "this" e usado nessa opção pq essa classe implementa o actionlistner o paraemtro e feito para o metodo que implementa o actionlistiner
...
public void actionPerformed(ActionEvent evento)
{
	...
	{
		JOptionPane.showMessageDialog(this, "Desenvolvido na Catolica");
	}
}
